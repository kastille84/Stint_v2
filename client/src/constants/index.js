...
export const ADD_TO_REWARD_GOAL = "ADD_TO_REWARD_GOAL";
export const ADD_TO_REWARD_GOAL_DONE = "ADD_TO_REWARD_GOAL_DONE";
export const SUBTRACT_FROM_REWARD_GOAL = "SUBTRACT_FROM_REWARD_GOAL";
export const SUBTRACT_FROM_REWARD_GOAL_DONE = "SUBTRACT_FROM_REWARD_GOAL_DONE";
