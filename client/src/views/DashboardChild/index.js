  ...
  render(){
    return (
      <section className="dashboard-parent">
        ...
        <div>{((this.props.user||{}).userData||{}).name? `${this.props.user.userData.name}'s Dashboard`:null}</div>
...
export default connect(mapStateToProps,mapDispatchToProps)(DashboardChild);