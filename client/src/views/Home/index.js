    ...
    return (
      <main className="home">
        ...
        <section className="home__info-strip home__info-strip-credentials">
          <div className="home__info-text">
              <Link to="/family-login" className="btn btn-success btn-credentials">Login</Link>
              <p className="mt20">Using these credentials</p>
          </div>
          <div className="home__info-text-credentials">
            <p>
              <span>Family Email:</span> <span>test@test.com</span>
              <span>Family Password:</span><span>test4400~</span>
            </p>
            <p>
              <span>Parent Name:</span> <span>Dad</span>
              <span>Parent Pin:</span><span>4400</span>
            </p>
          </div>
        </section>
      </main>
